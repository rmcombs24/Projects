...
public static class Version
{
    ...
    private static int FeatureNumber = 5; //Current Feature. Updated for each feature in a release
    private static int DevelopmentNumber = 8; //Development. Updated for any updates to dev  that arent features (refactors, classes, etc)
